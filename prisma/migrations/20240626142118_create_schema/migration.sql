...
-- CreateIndex
CREATE UNIQUE INDEX "_StatusToTask_AB_unique" ON "_StatusToTask"("A", "B");

-- CreateIndex
CREATE INDEX "_StatusToTask_B_index" ON "_StatusToTask"("B");
...
-- AddForeignKey
ALTER TABLE "_StatusToTask" ADD CONSTRAINT "_StatusToTask_A_fkey" FOREIGN KEY ("A") REFERENCES "Status"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_StatusToTask" ADD CONSTRAINT "_StatusToTask_B_fkey" FOREIGN KEY ("B") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;
